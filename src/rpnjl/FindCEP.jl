...
"""
function check_s_shape(T, ints; rho_range=6.00:-0.01:0.01)
...
function binary_search_CEP(T_lower, T_upper, ints; tolerance=0.01, rho_density=0.005)
    ...
    lower_result = check_s_shape(T_lower, ints, rho_range=6.00:-rho_density:0.01)
    upper_result = check_s_shape(T_upper, ints, rho_range=6.00:-rho_density:0.01)
    ...
    while T_upper - T_lower > tolerance && iter < max_iter
        ...
        result = check_s_shape(T_mid, ints, rho_range=6.00:-rho_density:0.01)
